...
const About = () => {
  return (
    <div className="relative w-[81.2vw] h-[100vh] left-[21.5%]">
        <h1 className="mt-12 ml-8 text-[2rem]">About</h1>
        <hr className="border-2 border-blue-500 w-[3.2rem] mt-4 ml-8"/>
        <p className="ml-8 my-3">I am a frontend developer with over 6 years of experience working with web technologies such as HTML, CSS, JavaScript, and WordPress. My journey in tech has equipped me with a diverse set of skills, and I am proud to hold international certifications, including Oracle Database SQL Certified Expert (OCE), Adobe Certified Associate (ACA) in Web Communications using Adobe Dreamweaver, and several New Horizons certifications in Java, Comptia A+, and CCNA, among others.</p>

        <div className="photodetails ml-8 flex justify-start gap-8 mt-20">
          <div className="left w-[18rem] h-[18rem] border-2">
          ...
          <div className="right">
            ...
            <p className="mt-4">Professionally, I serve as the Technical Officer at Daily Post Media Ltd, where I continue to leverage my expertise in web technologies and contribute to the organization's digital initiatives.</p>
