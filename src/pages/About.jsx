        ...
        <div className="w-full sm:w-2/3">
          ...
          <div className="flex flex-col sm:flex-row justify-start gap-8 mt-6">
            <div className="space-y-4">
              ...
              <h3><span className="font-bold">Website:</span> <a href="https://vercel.com/damilola-onis-projects/standard-portfolio" target="_blank" rel="noopener noreferrer" className="text-blue-500">https://vercel.com/damilola-onis-projects/standard-portfolio</a></h3>
